...
from loss.lwf_replay_loss import LwFLossReplay2, NaiveLwFLossReplay
...
"""Trainer for LwF + OCDM and YOLO LwF + OCDM"""
class YOLOLwFReaply(BaseCLODYOLO):
    ...
    def __init__(self, m_cfg, hparams, data_cfg_path_val, exp_folder, teacher_dict, logger=None, classes_per_task=None,*args, **kwargs):
        ...
        if len(self.lwf_params) > 2:
            ...
            self.criterion = LwFLossReplay2(self.m_cfg, self.modules["head"], self.device,

...
from trainer.lwf_trainer import YOLOLwF
...
if __name__ == "__main__":
    ...
    dire = "results" # 2 no cls power IoU, 3 no IoU e no masking
    ...
    for i, (train_loader, val_loader, other_info) in enumerate(TasksGenerator(m_cfg, data_cfg, hparams, exp_type, save_stats)):
        ...
        if i == 0:
            ...
            yolo_mind = YOLOLwF(m_cfg, hparams=hparams, data_cfg_path_val = data_cfg_new_path,

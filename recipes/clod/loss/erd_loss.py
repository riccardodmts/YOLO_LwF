...
class ERS(nn.Module):
    ...
    def __call__(self, student_cl_output, student_reg_output, teacher_output, anchors):
        ...
        weights_cls = self.ers_cls(target_scores[:,:, self.classes].detach())
        ...
        weights = self.ers_regression(target_distri_, target_scores, anchors)
